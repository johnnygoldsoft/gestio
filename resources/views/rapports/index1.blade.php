...
@section('content')
    ...
    <tr>
        ...
        <th class="cell">Activité Groupe</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          ...
          <li class="list-group-item"><strong>Activité Groupe :</strong> {{ $rapport->activiteGroup }}</li>
          ...
          <li class="list-group-item"><strong>Remarques faites :</strong> {{ $rapport->observationFait }}</li>
          <li class="list-group-item"><strong>Kits :</strong> {{ $rapport->kits }}</li>
          <li class="list-group-item"><strong>Nb personnes visitées :</strong> {{ $rapport->nbPersVisit }}</li>
