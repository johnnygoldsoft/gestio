...
@endif
        ...
        {{-- Activité Groupe et Remarque --}}
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="activiteGroup" class="form-label">Activité de Groupe</label>
                <textarea class="form-control" id="activiteGroup" name="activiteGroup" rows="5" required></textarea>
            </div>
            <div class="col-md-6 mb-3">
                <label for="remarque" class="form-label">Remarque faite</label>
                <textarea class="form-control" id="remarque" name="remarque" rows="5"></textarea>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="nbPres" class="form-label">Nombre de Présence</label>
        ...
        {{-- Observation Fait --}}
        <div class="mb-3">
            <label for="observationFait" class="form-label">Observation Fait</label>
            <textarea class="form-control" id="observationFait" name="observationFait" rows="5"></textarea>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="vaccination" name="vaccination">
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="commentMaladie" name="commentMaladie">
        </div>
