        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @foreach ($rapports as $rapport)
                    <tr>
                        ...
                        <td class="text-large">{{ $rapport->activiteGene }}</td>
                        <td class="text-large">{{ $rapport->remarque }}</td>
                        <td>{{ $rapport->nbPres }}</td>
                        <td>{{ $rapport->visite }}</td>
                        <td class="text-large">{{ $rapport->remarqueFait }}</td>
                        <td>{{ $rapport->kits }}</td>
                        <td>{{ $rapport->nbPersVisitSem }}</td>
            ...
            <tfoot>
                <tr class="table-light fw-bold text-end">
                    ...
                    <td>{{ $rapports->sum('nbPersVisitSem') }}</td>
