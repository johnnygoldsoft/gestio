...
//             $q->where('activiteGroup', 'like', "%{$search}%")
//               ->orWhere('remarque', 'like', "%{$search}%")
//               ->orWhere('observationFait', 'like', "%{$search}%")
...
public function index(Request $request)
{
    ...
    public function store(StoreRapportRequest $request)
    {
        ...
        Rapport::create([
            ...
            'mois' => $date->month,
            'annee' => $date->year,
            'activiteGroup' => $request->activiteGroup,
            'remarque' => $request->remarque,
            'nbPres' => $request->nbPres,
            'visite' => $request->visite,
            'observationFait' => $request->observationFait,
            'kits' => $request->kits,
            ...
            'commentMaladie' => $request->commentMaladie,
